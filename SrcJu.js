        ...
        try {
            ...
            if(!noShow.排序){
                ...
                d.push({
                    ...
                    url: $(["修整选集标题:"+(reviseLiTitle=="1"?"是":"否"),"显示扩展项:"+(getItem('extenditems','1')=="1"?"是":"否"),"线路样式:"+getItem('SrcJuLine_col_type', 'scroll_button'),"选集样式:"+getItem('SrcJuList_col_type', '自动'),"选集分页设置","二级简洁模式:"+(juItem2.get('二级简洁模式')?"否":"是")], 1, "样式设置").select(() => {
                        if(input=="选集分页设置"){
