                ...
                return {
                    ...
                    url: $('hiker://empty#noRecordHistory##noHistory##noRefresh#').rule((dmSource, bangumiId, data) => {
                        ...
                        dmepisodes.forEach(it=>{
                            let episodeTitle = (it.episodeTitle.includes('】')?it.episodeTitle.split('】')[1]:it.episodeTitle).replace(data.name, '').replace(/-|_/g, '').trim();
                            d.push({
...
function getThemeList(isEnable) {
    ...
    if(isEnable){
        let currentTheme = storage0.getItem('currentTheme', {
            名称: '原生主题',
            主页图标: [{
                "img": "http://123.56.105.145/juyue/themes/078/1_切源.svg",
                "color": "#ccc"
            }, {
                "img": "http://123.56.105.145/juyue/themes/078/1_频道.svg",
                "color": "#ccc"
            }, {
                "img": "http://123.56.105.145/juyue/themes/078/1_搜索.svg",
                "color": "#ccc"
            }, {
                "img": "http://123.56.105.145/juyue/themes/078/1_收藏.svg",
                "color": "#ccc"
            }, {
                "img": "http://123.56.105.145/juyue/themes/078/1_管理.svg",
                "color": "#ccc"
            }],
            "二级图标": [{
            ...
            "书架图标": [{
                ...
                "img": "http://123.56.105.145/juyue/themes/078/s_样式.svg",
                "color": "#ccc"
            }, {
                "img": "http://123.56.105.145/juyue/themes/078/s_收藏.svg",
                "color": "#ccc"
            }],
            "接口图标": [{
...
function outputSearchList(jkdatalist, input){
    ...
    jkdatalist = jkdatalist.filter(it=>{
        if(input.startsWith('txt:')){
            return fetch(it.url).includes(input.split('txt:')[1]);
        }
