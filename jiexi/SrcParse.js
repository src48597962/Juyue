    ...
    function exeWebRule(webObj, music) {
        ...
        return executeWebRule(webUrl, $.toString((music,webUrl) => {
            try{
                ...
                var exclude = /\/404\.m3u8|\/xiajia\.mp4|\/余额不足\.m3u8|\.avif|\.css|\.js|\.gif|\.png|\.jpg|\.jpeg|html,http|m3u88.com\/admin|\.php\?v=h|url=http|vid=http|%253Furl%253Dh|#amp=1|\.t-ui\.cn|ac=dm/;//设置排除地址
